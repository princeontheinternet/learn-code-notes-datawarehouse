...
ALTER SHARE ORDERS_SHARE ADD ACCOUNT= qbb27470 ;
...
-- CREATING INBOUND SHARE

CREATE DATABASE "DB_NAME" 
FROM SHARE qbb27470."ORDERS_SHARE";

GRANT IMPORTED PRIVILEGES ON DATABASE "DB_NAME" TO ROLE "SYSADMIN";

USE ROLE SYSADMIN;

SELECT * FROM DB_NAME.PUBLIC.ORDERS_SHARE;
