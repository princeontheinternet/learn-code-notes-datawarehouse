...
//Checking Inbound Share data & also creating tables and views for Outbound Share
...
ALTER USER NOOB --*** replace 'FDNEIGE' with your User Name
...
//LAB 2 - EXERCISE 8 ----------------------------------;
-- Load the three tables using the csv files provided using WEBUI.


PUT file://<file_path>/ISO_Countries_UTF8_pipe.csv @INT_STDS_ORG_3661/ui1620904708939

COPY INTO "INTL_DB"."PUBLIC"."INT_STDS_ORG_3661" FROM @/ui1620904708939
FILE_FORMAT = '"INTL_DB"."PUBLIC"."PIPE_DBLQUOTE_HEADER_CR"'
ON_ERROR = 'ABORT_STATEMENT'
PURGE = TRUE;


PUT file://<file_path>/currencies.csv @CURRENCIES/ui1620905199542

COPY INTO "INTL_DB"."PUBLIC"."CURRENCIES" FROM @/ui1620905199542
FILE_FORMAT = '"INTL_DB"."PUBLIC"."CSV_COMMA_LF_HEADER"'
ON_ERROR = 'ABORT_STATEMENT'
PURGE = TRUE;


PUT file://<file_path>/country_code_to_currency_code.csv @COUNTRY_CODE_TO_CURRENCY_CODE/ui1620905247772

COPY INTO "INTL_DB"."PUBLIC"."COUNTRY_CODE_TO_CURRENCY_CODE" FROM @/ui1620905247772
FILE_FORMAT = '"INTL_DB"."PUBLIC"."CSV_COMMA_LF_HEADER"'
ON_ERROR = 'ABORT_STATEMENT'
PURGE = TRUE;
